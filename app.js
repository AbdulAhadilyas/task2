...
function sum() {
  ...
  // for (let i = 0; i < userInput1; i++) {
  //   for (let j = 0; j < userInput2; j++) {
  //     let res1 = Number(document.querySelector(`#matirx1_${i}${j}`).value);

  //     // let res2 = Number(document.querySelector(`#matirx2_${i}${j++}`).value);
  ...
  for (let i = 0; i < userInput1; i++) {
    ...
    for (let i = 0; i < userInput1; i++) {
      for (let j = 0; j < userInput2; j++){
        let res3 = Number(document.querySelector(`#matirx2_${i}${++j}`).value);
        // let res3 = Number(document.querySelector(`#matirx2_${i}${j}`).value);
        console.log(res3)
      }
    }
